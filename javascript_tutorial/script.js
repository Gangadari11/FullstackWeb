...
//         text : "You are in the town square.You see a sign that sasy \"store.\""
//     }
//     ,
//     {
//         name: "store",
...
//         text : "You are fghting a monster"
//     },
//     {
//         name: "kill onster",
...
//     monsterStats.computedStyleMap.display = "block"; //update css through javascript
//     monsterHealthText.innerText = montorHealth;
// }
// function attack(){
//     text.innerText = "The " + monsters[fighting].name + " attacks";
//     text.innerText = text.innerText+" You attack it with your "+ weapons[currentweapon].name + ".";
//     monsterHealth = montorHealth-weapons[currentweapon].power;
...
// //The above if else statement do the same thing as the following line
